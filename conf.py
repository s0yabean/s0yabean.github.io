...
BLOG_AUTHOR = "Tony Tong Tsz Hin"  # (translatable)
BLOG_TITLE = "Tony's Data Science Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://s0yabean.github.io"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "tonytongwa@gmail.com"
BLOG_DESCRIPTION = "Technical Blog | Data Science Portfolio | Career Learnings"  # (translatable)
